    ...
    <div class="rounded-[26px] border border-white/20 bg-white/10 p-6 backdrop-blur-2xl sm:p-7">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2 text-[11px] sm:text-xs">
                {{-- SHIFT --}}
                <span class="rounded-full px-3 py-1 font-semibold text-black" style="background:#22c55e">Shift A
                    (10–19)</span>
                <span class="rounded-full px-3 py-1 font-semibold text-black" style="background:#f59e0b">Shift B
                    (13–22)</span>
        ...
        <div id="pegawaiCalHint"
            class="mt-4 rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white/85">
