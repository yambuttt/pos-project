...
@section('body')
    ...
    <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gold-gradient">Tambah Foto</h1>
            <p class="text-sm text-white/40 font-medium">Unggah foto baru untuk ditampilkan di galeri landing page.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 glass-panel p-8 rounded-[2.5rem] space-y-6">
                <div class="space-y-2">
                    ...
                    <input name="title" value="{{ old('title') }}" placeholder="Contoh: Interior Ambiance, Signature Dish"
            ...
            <div class="space-y-8">
                <div class="glass-panel p-8 rounded-[2.5rem]">
                    <label class="text-[10px] uppercase tracking-widest text-white/40 font-bold ml-1 mb-4 block">File Foto</label>
                    ...
                    <div class="relative group cursor-pointer border-2 border-dashed border-white/5 rounded-3xl p-8 text-center hover:border-gold-primary/30 hover:bg-white/[0.02] transition-all">
                        <input name="image" type="file" id="galleryImageInput" accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer" required>
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <p id="uploadLabel" class="text-[10px] text-white/30 font-bold uppercase tracking-widest text-center">Pilih Gambar</p>
                        </div>
                    </div>
                    <p class="mt-4 text-[10px] text-center text-white/20 leading-relaxed italic">JPG, PNG, atau WEBP (Maksimal 5MB)</p>
                </div>
