            ...
            <div class="flex items-center gap-2">
                ...
                @if ($sale->payment_status === 'paid')
                    <div class="flex gap-2">
                        <a href="{{ route('kasir.sales.print', $sale) }}" target="_blank"
                            class="rounded-xl bg-blue-600/85 px-4 py-2 text-sm font-semibold">
                            Invoice A4
                        </a>

                        <a href="{{ route('kasir.sales.print-thermal', [$sale, 'paper' => '58']) }}" target="_blank"
                            class="rounded-xl bg-amber-500/90 px-4 py-2 text-sm font-semibold text-black">
                            Struk 58mm
                        </a>

                        <a href="{{ route('kasir.sales.print-thermal', [$sale, 'paper' => '80']) }}" target="_blank"
                            class="rounded-xl bg-emerald-500/90 px-4 py-2 text-sm font-semibold text-black">
                            Struk 80mm
                        </a>
                    </div>
                @endif
                ...
                @if ($sale->payment_status === 'pending')
                    <div class="mt-4 rounded-2xl border border-yellow-500/20 bg-yellow-500/10 p-4">
                        ...
                        @if (!empty($payment['va_number']))
                            ...
                            <div
                                class="mt-2 rounded-xl border border-white/10 bg-black/20 px-4 py-3 text-lg font-semibold tracking-wider">
                                {{ $payment['va_number'] }}
                            </div>
