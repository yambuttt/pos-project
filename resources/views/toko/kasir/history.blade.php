...
<div class="max-w-7xl mx-auto space-y-8 animate-fade-up" x-data="historyPage()">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-sm group hover:border-yellow-500/30 transition-all duration-500">
    ...
    <!-- Table Section -->
    <div class="bg-white/5 border border-white/10 rounded-[32px] overflow-hidden backdrop-blur-md shadow-2xl relative">
    ...
    <div x-show="selectedSale" 
        ...
        <div class="bg-[#0a0a0a] border border-white/10 w-full max-w-lg rounded-3xl md:rounded-[40px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative mx-auto"
            ...
            <div class="p-6 md:p-8 border-b border-white/5 flex items-center justify-between">
                ...
                <button @click="selectedSale = null" class="p-2 hover:bg-white/5 rounded-full text-white/20 hover:text-white transition-all">
                    <svg class="w-5 h-5 md:w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></button>
                </div>
            </div>
