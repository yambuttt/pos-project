...
<body class="antialiased h-screen flex flex-col overflow-hidden selection:bg-yellow-500 selection:text-black">
    ...
    <header class="h-[72px] glass-topbar flex items-center justify-between px-4 sm:px-6 z-30 shrink-0">
        ...
        <nav class="hidden lg:flex items-center gap-2">
            ...
            <a href="{{ route('toko.kasir.history') }}" 
               class="nav-btn {{ request()->routeIs('toko.kasir.history') ? 'active border-yellow-500/40' : 'text-white/70 border-transparent' }} px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-2">
  ...
  <div class="lg:hidden bg-[#0a0a0a] border-b border-white/5 flex overflow-x-auto">
        ...
        <a href="{{ route('toko.kasir.history') }}" 
           class="flex-none px-4 py-3 text-xs uppercase tracking-wider {{ request()->routeIs('toko.kasir.history') ? 'font-bold text-yellow-500 border-b-2 border-yellow-500' : 'font-medium text-white/50 hover:text-white' }}">
           Riwayat
        </a>
    </div>
